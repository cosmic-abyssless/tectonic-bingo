...
- **Who earns it:** The Player who did the thing, through the app, so the unlock plays on their own device. Posting a teammate's drop earns the poster "Strong start", not the teammate the drop is credited to. The exception is an Achievement for what teammates do to your drop (Reactions on it): that one goes to the Player the Submission is credited to, and its popup waits for them.
