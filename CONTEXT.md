...
- **Unlock:** Announced once, on the Player's own device, with a popup in the style of OSRS's combat achievement and collection log popups (icon, title, and a line of **flavour text** underneath; the plain description of how it's earned is shown in the Player's list of Achievements). If they weren't there to see it, it plays next time they open the Bingo; several queue one after another.
