...
const DEFS: WildcardDef[] = [
  ...
  },
  {
    ...
    itemName: "Sire jar",
    description: "May substitute for one piece of Abyssal bludgeon (spine, limb, or axon).",
    applicableToSide: 'B',
  },
  {
    tileName: 'Duke Sucellus',
    itemName: "Duke's soulreaper piece",
  ...
  {
    tileName: 'COX 1',
    itemName: "COX mega rare",
    description: "Any COX mega rare (Twisted bow, Kodai insignia, Elder maul) may substitute for any single COX 1 required item.",
  },
  {
    tileName: 'Zulrah',
  ...
  {
    tileName: 'Whisperer',
    itemName: "Whisperer's soulreaper piece",
  ...
  // ── VAMPYRIC ─────────────────────────────────────────────────────────────
  {
    ...
    description: "May substitute for one piece of Justiciar armour. Cannot be used for both TOB 1 and TOB 2 — one Scythe covers one tile only.",
  },
  {
    tileName: 'Vardorvis',
    itemName: "Vardorvis' soulreaper piece",
  ...
  // ── DESERT ───────────────────────────────────────────────────────────────
  {
    tileName: 'Colosseum',
    itemName: "Ralos' sun",
    description: "May substitute for any single Colosseum item (Echo crystal or Sunfire piece).",
  },
  {
    tileName: 'TOA 1',
    itemName: "Tumeken's shadow",
    description: "May substitute for any single TOA 1 item. If two Shadows are obtained, one may be used for TOA 1 and one for TOA 2.",
  },
  {
    tileName: 'TOA 2',
    itemName: "Tumeken's shadow",
    description: "May substitute for any single TOA 2 item. If two Shadows are obtained, one may be used for TOA 1 and one for TOA 2.",
  },
  {
    tileName: 'Leviathan',
    itemName: "Leviathan's soulreaper piece",
...
async function seed() {
  ...
  if (existing.length > 0) { console.log('tile_wildcards already seeded, skipping.'); return; }
