...
/** What the Dry card calls each boss. Not the wiki page: raids have none, and Barrows' is "Chest (Barrows)". */
export const BOSS_NAMES: Record<BossMetric, string> = {
