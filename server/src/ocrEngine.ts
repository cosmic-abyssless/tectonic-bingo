...
/** Reads the text in an image, one string per line, waiting its turn behind the concurrency limit. */
export function recognizeLocally(buffer: Buffer, priority: OcrPriority): Promise<string[]> {
