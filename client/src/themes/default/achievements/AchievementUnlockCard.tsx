...
export function AchievementUnlockCard({ achievement }: { achievement: MyAchievement }) {
  return (
    <div className="flex w-[min(30rem,calc(100vw-32px))] items-center gap-4 rounded-md border-2 border-t-[3px] border-achievement-border bg-achievement-surface px-5 py-4 shadow-pop">
