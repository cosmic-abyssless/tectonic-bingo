...
export function AchievementUnlockCard({ achievement }: { achievement: MyAchievement }) {
  ...
  return (
    <div
      className="flex w-[min(30rem,calc(100vw-32px))] items-center gap-4 border-[3px] px-4 py-3"
    ...
    >
      ...
      <div className="min-w-0">
        <div className="text-3xl uppercase leading-none tracking-wide [overflow-wrap:anywhere]" style={{ fontFamily: COMIC_FONT }}>
          {achievement.name}
        </div>
